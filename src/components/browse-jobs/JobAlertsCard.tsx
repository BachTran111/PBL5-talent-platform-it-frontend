  ...
  return (
    <section className='overflow-hidden rounded-[26px] border border-violet-200/80 bg-[radial-gradient(circle_at_top_right,_rgba(168,85,247,0.20),_transparent_38%),linear-gradient(180deg,#fbf7ff_0%,#f6efff_100%)] p-5 shadow-[0_16px_42px_rgba(124,58,237,0.08)]'>
      ...
      <div className='space-y-2.5'>
        <h3 className='text-[1.75rem] font-semibold tracking-[-0.03em] text-slate-950'>{t('browseJobs.alerts.title')}</h3>
        <p className='text-[15px] leading-7 text-slate-600'>
          {t('browseJobs.alerts.description')}
        </p>
      </div>
      <PrimaryButton className='mt-5 w-full rounded-xl py-3 text-sm'>{t('browseJobs.alerts.enable')}</PrimaryButton>
    </section>
  )
}
